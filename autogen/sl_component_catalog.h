...
#define SL_CATALOG_CLIENT_PRESENT
#define SL_CATALOG_SIMPLE_LED_PRESENT
#define SL_CATALOG_SIMPLE_LED_CLIENT_PRESENT
#define SL_CATALOG_COMM_PRESENT
#define SL_CATALOG_SIMPLE_LED_COMM_PRESENT
#define SL_CATALOG_FAULT_PRESENT
#define SL_CATALOG_SIMPLE_LED_FAULT_PRESENT
